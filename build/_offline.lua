...
-- luacheck: push ignore install_manifest cbin_offline app_files dep_files lgray green white
...
lgray()
print("Hint: You can use 'cbin' to manage your off-line installation.")
white()
